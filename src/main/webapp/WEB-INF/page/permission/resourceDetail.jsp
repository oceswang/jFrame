...
<div class="modal-header">
   ...
   <h4 class="modal-title" id="res-modal-label"> 模态框（Modal）标题</h4>
</div>
...
<div class="modal-footer">
   ...
   <button type="button" class="btn btn-primary" id="save-resource-btn">提交更改</button>
</div>
<script>
$(function(){
