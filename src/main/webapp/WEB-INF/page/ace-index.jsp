...
<html lang="en">
	<head>
		...
		<!--[if !IE]> -->
		<link rel="stylesheet" href="${basePath}/assets/css/pace.css" />

		<script data-pace-options='{ "ajax": true, "document": true, "eventLag": false, "elements": false }' src="${basePath}/assets/js/pace.js"></script>
	...
	<body class="no-skin">
						...
						<li class="light-blue">
							<a data-toggle="dropdown" href="#" class="dropdown-toggle">
								...
								<span class="user-info">
									<small>Welcome,</small>
									${sessionScope.__user__.userName}
								</span>
			...
			<div id="sidebar" class="sidebar                  responsive">
				...
				<div class="sidebar-shortcuts" id="sidebar-shortcuts">
					<div class="sidebar-shortcuts-large" id="sidebar-shortcuts-large">
						...
						<a class="btn btn-warning" href="#permission.do">
				...
				<ul class="nav nav-list" id="sidemenu">
					<li class="">
						<a data-url="dashboard.do" href="#dashboard.do">
		...
		<!--[if !IE]> -->
		<script type="text/javascript">
			window.jQuery || document.write("<script src='${basePath}/plugins/jquery/jquery-1.11.1.js'>"+"<"+"/script>");
		</script>
...
<![endif]-->
		...
		<script src="${basePath}/assets/js/fuelux/fuelux.spinner.js"></script>
		<script src="${basePath}/assets/js/date-time/bootstrap-datepicker.js"></script>
		<script src="${basePath}/assets/js/date-time/bootstrap-timepicker.js"></script>
		...
		<script src="${basePath}/assets/js/bootstrap-colorpicker.js"></script>
		<script src="${basePath}/assets/js/jquery.knob.js"></script>
		<script src="${basePath}/assets/js/jquery.autosize.js"></script>
		...
		<script src="${basePath}/assets/js/bootstrap-tag.js"></script>
		...
		<script src="${basePath}/plugins/zTree/js/jquery.ztree.all-3.5.js"></script>
		
		
		<script src="${basePath}/plugins/jquery-validate/jquery.validate.min.js"></script>
		<script src="${basePath}/plugins/jquery-validate/additional-methods.min.js"></script>
		<script src="${basePath}/plugins/jquery-validate/messages_zh.min.js"></script>
		<script src="${basePath}/js/sidemenu.js"></script>
